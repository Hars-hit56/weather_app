const colors = {
  THEME: 'rgba(0, 123, 255, 1)',
  LIGHT_THEME_08: 'rgba(0, 123, 255, 0.8)',
  LIGHT_THEME_06: 'rgba(0, 123, 255, 0.6)',
  LIGHT_THEME_04: 'rgba(0, 123, 255, 0.4)',
  LIGHT_THEME_02: 'rgba(0, 123, 255, 0.2)',
  LIGHT_THEME_01: 'rgba(0, 123, 255, 0.1)',

  APP_BACKGROUND_WHITE: '#FFFFFF',
  APP_BACKGROUND: '#F9FAFB',
  AUTH_APP_BACKGROUND: '#EDF1F3',
  APP_BLUE: '#7CC5F1',
  PENDING_STATUS_YELLOW: '#A16207',

  STATUS_GREEN: '#DCFCE7',
  STATUS_RED: '#FEE2E2',
  SELECTED_TAB_COLOR: '#1D1B20',
  SELCTED_BLACK: 'rgba(0, 0, 0, 0.1)',

  TRANSPARENT: 'rgba(0, 0, 0, 0)',
  TRANSPARENT_BLACK: 'rgba(0, 0, 0, 0.1)',
  TRANSPARENT_BLACK_HARD: 'rgba(0, 0, 0, 0.9)',

  SEPARATOR_COLOR: '#e0e0e0',
  SKELETON_BACKGROUND_COLOR: '#F4F7FD',
  SKELETON_HIGHLIGHT_COLOR: 'rgba(1, 71, 146, 0.1)',

  THUNDERSTROM_COLOR: '##21294d',
  DRIZZLE_COLOR: '#2F4F4F',
  RAIN_COLOR: '#243048',
  SNOW_COLOR: '#B3E5FC',
  ATMOSPHERE_COLOR: '#8F87F1',
  CLEAR_COLOR: '#1976D2',
  CLOUDS_COLOR: '#4f76c3',
